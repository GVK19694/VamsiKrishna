...
public class AEMPackageCreation extends SlingSafeMethodsServlet {
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
        ...
        filterPaths.add("/content/VamsiKrishna");
        filterPaths.add("/conf/VamsiKrishna/settings/wcm");
        filterPaths.add("/apps/VamsiKrishna");
        filterPaths.add("/apps/VamsiKrishna-packages");
